  ...
  function() {
    function BaseField2() {
      ...
      this.invoke = function(name) {
        ...
        return (_b = (_a = _this.actions)[name]) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArray2([_a], __read2(args), false));
      };
    }
            ...
            switch (_a.label) {
              case 0:
                isHTMLInputEventFromSelf = function(args2) {
                  var _a2, _b;
                  return isHTMLInputEvent(args2[0]) && "currentTarget" in args2[0] ? ((_a2 = args2[0]) === null || _a2 === void 0 ? void 0 : _a2.target) === ((_b = args2[0]) === null || _b === void 0 ? void 0 : _b.currentTarget) : true;
                };
                getValues = function(args2) {
                  var _a2;
                  if ((_a2 = args2[0]) === null || _a2 === void 0 ? void 0 : _a2.target) {
  ...
  return function() {
    ...
    if (GlobalState.effectStart) {
      GlobalState.lifecycles.push(new LifeCycle(type, function(payload, ctx) {
        if (isFn(callback)) {
          callback.apply(void 0, __spreadArray3([payload, ctx], __read3(GlobalState.context), false)).apply(void 0, __spreadArray3([], __read3(args), false));
        }
      }));
    } else {
    ...
    function ArrayField2(address, props, form, designable) {
      ...
      _this.push = function() {
        ...
        return action(function() {
          ...
          (_a = _this.value).push.apply(_a, __spreadArray4([], __read4(items), false));
      ...
      _this.insert = function(index) {
        ...
        return action(function() {
          ...
          (_a = _this.value).splice.apply(_a, __spreadArray4([index, 0], __read4(items), false));
          return _this.onInput(_this.value);
        });
      };
      ...
      _this.unshift = function() {
        ...
        return action(function() {
          ...
          (_a = _this.value).unshift.apply(_a, __spreadArray4([], __read4(items), false));
          return _this.onInput(_this.value);
        });
      };
...
//# sourceMappingURL=chunk-IFJRZNIX.js.map
